...
-- ETL LOAD ORDER: Dim_Category_Translation must be fully loaded BEFORE Dim_Product.
-- Products with a category name absent from Dim_Category_Translation will violate fk_translator_languagage.
-- ETL must either (a) pre-insert any unmapped category name into Dim_Category_Translation
-- with a NULL English name, or (b) set product_category_name to NULL for unresolved products.
